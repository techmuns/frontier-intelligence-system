...
the analysis was built in. Eleven flat tabs was the problem, and hiding seven
behind a "more" toggle only moved it — unfolding still gave you eleven flat
tabs. So the seven deeper views are filed under the three questions they
actually answer:

| Tab | Holds |
| --- | --- |
| Overview | The six findings |
| Companies | Every company, searchable |
| Over time | The trends, batch by batch |
| **What they build** | Groups of similar companies · Where they sit in the market |
| **What's changing** | Directions · Shifts worth noticing · Who has traction |
| **What they depend on** | Jobs & tools · Gaps nobody fills |
| How it's counted | The method |

Nothing was dropped. A reader meets three questions instead of seven unrelated
nouns, and opens only the one they are asking. Regrouping changes no data —
every number still comes from the same datasets.
